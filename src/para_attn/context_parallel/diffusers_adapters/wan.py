...
def parallelize_transformer(transformer: WanTransformer3DModel, *, mesh=None):
    ...
    def call_transformer_blocks(self, hidden_states, encoder_hidden_states, *args, **kwargs):
        # print(self, "call_transformer_blocks")
        # print("=========,",self.blocks)
        if torch.is_grad_enabled() and self.gradient_checkpointing:
            ...
            # print("==============,not gradient_checkpointing")
            for block in self.blocks:
    ...
    # print("qqqqqqqqqqqq transformer._is_parallelized", transformer._is_parallelized)
    # print(transformer, "is parallelized qqqqqqqqqqqqqqqqqq" )
    return transformer


def parallelize_pipe(pipe: DiffusionPipeline, *, shallow_patch: bool = False, **kwargs):
    # logger.info("-------- Parallelizing pipeline --------",shallow_patch)
    # print("-------- Parallelizing pipeline --------",shallow_patch)
